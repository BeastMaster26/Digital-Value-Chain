      ...
      <div className="w-full max-w-md mx-auto font-sans">
        <CardContent className="flex flex-col gap-6">
          <div className="flex flex-col gap-1">
            ...
            <h1 className="text-3xl font-bold text-[#00A3A8]">Digital Value Chain</h1>
            <p className="text-3xl font-bold text-[#00A3A8]">Gold Bank Syariah Indonesia</p>
          </div>
          <div className="space-y-4 text-sm text-gray-700">
            <input className="w-full border-b border-gray-500 bg-transparent outline-none py-2" placeholder="Gold Company Code" />
